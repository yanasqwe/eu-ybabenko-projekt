...
const I18N_DICT = {
  ...
  /* EU-Bot (Kontaktseite) */
  "bot.title":    { de: "EU-Bot", en: "EU Bot", ru: "ЕС-бот", zh: "欧盟机器人" },
  "bot.subtitle": { de: "Schnelle Antworten zur EU", en: "Quick answers about the EU", ru: "Быстрые ответы о ЕС", zh: "关于欧盟的快速解答" },
  "bot.ph":       { de: "Frag etwas über die EU …", en: "Ask something about the EU …", ru: "Спроси что-нибудь о ЕС …", zh: "问一些关于欧盟的问题……" },
  "bot.send":     { de: "Senden", en: "Send", ru: "Отправить", zh: "发送" },
  "bot.greeting": {
    de: "Hallo! Ich beantworte Fragen zur Europäischen Union — zum Beispiel zu einem Land, einem Jahr oder Themen wie Schengen, dem Euro oder dem Brexit. Was möchtest du wissen?",
    en: "Hi! I answer questions about the European Union — for example about a country, a year, or topics like Schengen, the euro or Brexit. What would you like to know?",
    ru: "Привет! Я отвечаю на вопросы о Европейском союзе — например, о стране, годе или темах вроде Шенгена, евро или Brexit. Что хочешь узнать?",
    zh: "你好！我回答关于欧洲联盟的问题——例如某个国家、某一年，或申根、欧元、英国脱欧等主题。你想了解什么？",
  },
  "bot.thanks":   { de: "Gern geschehen! 🙂", en: "You're welcome! 🙂", ru: "Пожалуйста! 🙂", zh: "不客气！🙂" },
  "bot.fallback": {
    de: "Das weiß ich leider nicht. Ich kenne mich nur mit der EU aus — frag zum Beispiel nach einem Land, dem Euro oder Schengen. Wenn du keine passende Antwort findest, schreib deine Frage unten im Formular.",
    en: "Sorry, I don't know that. I only know about the EU — try asking about a country, the euro or Schengen. If you can't find a suitable answer, write your question in the form below.",
    ru: "К сожалению, я этого не знаю. Я разбираюсь только в ЕС — спроси, например, о стране, евро или Шенгене. Если не найдёшь подходящий ответ, напиши свой вопрос ниже в форме.",
    zh: "抱歉，这个我不知道。我只了解欧盟——可以问某个国家、欧元或申根。如果找不到合适的答案，请在下方的表单中写下你的问题。",
  },
  "bot.note": {
    de: 'Keine Antwort erhalten? <a href="#contactForm">Schreib deine Frage unten im Formular ↓</a>',
    en: 'Didn\'t get an answer? <a href="#contactForm">Write your question in the form below ↓</a>',
    ru: 'Не получил ответа? <a href="#contactForm">Напиши свой вопрос ниже в форме ↓</a>',
    zh: '没有得到答案？<a href="#contactForm">在下方表单中写下你的问题 ↓</a>',
  },
  "bot.a.founded": {
    de: "Die EU in ihrer heutigen Form wurde 1993 durch den Vertrag von Maastricht gegründet. Ihre Wurzeln reichen bis 1951 (Montanunion) und 1957 (Römische Verträge) zurück.",
    en: "The EU in its present form was founded in 1993 by the Treaty of Maastricht. Its roots go back to 1951 (Coal and Steel Community) and 1957 (Treaties of Rome).",
    ru: "ЕС в его нынешнем виде был основан в 1993 году Маастрихтским договором. Его корни уходят в 1951 год (Объединение угля и стали) и 1957 год (Римские договоры).",
    zh: "现今形式的欧盟于1993年由《马斯特里赫特条约》创立。其根源可追溯到1951年（煤钢共同体）和1957年（《罗马条约》）。",
  },
  "bot.a.members": {
    de: "Die EU hat 27 Mitgliedsländer (seit dem Brexit 2020).",
    en: "The EU has 27 member states (since Brexit in 2020).",
    ru: "В ЕС 27 стран-членов (после Brexit в 2020 году).",
    zh: "欧盟有27个成员国（自2020年英国脱欧后）。",
  },
  "bot.a.pop": {
    de: "In der EU leben rund 449 Millionen Menschen — einer der größten Binnenmärkte der Welt.",
    en: "Around 449 million people live in the EU — one of the largest single markets in the world.",
    ru: "В ЕС проживает около 449 миллионов человек — один из крупнейших единых рынков мира.",
    zh: "欧盟约有4.49亿居民——是世界上最大的统一市场之一。",
  },
  "bot.a.lang": {
    de: "Die EU hat 24 Amtssprachen. In 20 Ländern gilt der Euro als Währung.",
    en: "The EU has 24 official languages. The euro is the currency in 20 countries.",
    ru: "В ЕС 24 официальных языка. Евро является валютой в 20 странах.",
    zh: "欧盟有24种官方语言。欧元在20个国家作为货币使用。",
  },
  ...
  "contact.lead": {
    de: "Du hast eine Frage zur Europäischen Union? Frag zuerst den Bot — findest du keine Antwort, schreib mir direkt über das Formular.",
    en: "Do you have a question about the European Union? Ask the bot first — if you don't find an answer, write to me directly via the form.",
    ru: "Есть вопрос о Европейском союзе? Сначала спроси бота — если не найдёшь ответ, напиши мне напрямую через форму.",
    zh: "你对欧洲联盟有疑问吗？先问问机器人——如果找不到答案，可以通过表单直接写信给我。",
  },
